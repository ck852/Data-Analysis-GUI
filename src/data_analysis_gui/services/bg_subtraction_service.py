...
class BackgroundSubtractionService:
    ...
    def apply_background_subtraction(
        ...
        Args:
            ...
            channel_definitions (ChannelDefinitions): Channel mapping definitions  
            start_ms (float): Start time of background range (ms)
            end_ms (float): End time of background range (ms)
        ...
        if channel_definitions is None:
            return BackgroundSubtractionResult(
                success=False, 
                error_message="Channel definitions cannot be None"
            )
        ...
        current_channel = channel_definitions.get_current_channel()
